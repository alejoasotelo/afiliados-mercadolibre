...
import { ProductoCompleto, ProductoSheet } from '@/lib/types';
                  ...
                  >
                    {imgRel && (
                      <div className="relative aspect-square bg-gray-50 rounded-lg overflow-hidden mb-2">
                        <Image src={imgRel} alt={rel.titulo} fill sizes="160px" className="object-contain p-2 group-hover:scale-105 transition-transform" />
                      </div>
                    )}
